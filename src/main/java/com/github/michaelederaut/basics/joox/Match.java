 ...
 */
package com.github.michaelederaut.basics.joox;
...
public interface Match extends Iterable<Element> {
     ...
     * This only works if the underlying document is namespace-aware
     * 
     * @param indexes array of integer
     * @return {@link List}
     *
     * @see Node#getNamespaceURI()
     */
     ...
     * 
     * @param elements array of {@link Element}
     * @return {@link Match} 
     */
     ...
     * Add some elements to the set of matched elements
     * 
     *  @param elements array of {@link Match}
     *  @return {@link Match}
     */
     ...
     * </ul>
     * 
     * <b>Using jOOX with Namespaces</b>
     * <br><br>
     ...
     * 
     * @param content array of {@link Match}
     * @return {@link Match}
     * 
     */
     ...
     * of matched elements, then the added content is duplicated.
     * 
     * @param content array of {@link Element}
     * @return {@link Match} 
     * 
     */
     ...
     * of matched elements.<br> Every element in the set of matched elements will be
     * replaced by its corresponding {@link Result}<br> obtained from the
