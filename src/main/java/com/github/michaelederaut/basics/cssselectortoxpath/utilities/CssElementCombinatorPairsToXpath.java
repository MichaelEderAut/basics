...
import com.github.michaelederaut.basics.cssselectortoxpath.model.CssElementCombinatorPair;
...
//		}
	...
	private void convertCssAttributeListToXpath(StringBuilder xpathBuilder, CssElementCombinatorPair elementCombinatorPair)
	{
		...
		for(CssAttribute cssAttribute: cssAttributeList)
		{
			...
			else if(cssAttribute.getType()==CssAttributeValueType.CARET_EQUAL)
			{
...
//				xpathBuilder.append("\")]");
			...
			else if(cssAttribute.getType()==CssAttributeValueType.TILDE_EQUAL)
			{
