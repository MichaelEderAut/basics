...
public class TestCssify02 {
	public static void main(final String args[]) {
		...
		System.out.println("xpath: \'" + S_xpath + "\' - css_value: \'" + O_conv_res_01.S_value + "\' - err_msg_01: " +  O_conv_res_01.S_err_msg + LF +
				           ...
				           ((O_dom_navi_01.O_xpath2dom_parsing_failure != null) ? 
				        	  ("- msg: " + O_dom_navi_01.O_xpath2dom_parsing_failure.S_msg +
				        	  " - pos: " + O_dom_navi_01.O_xpath2dom_parsing_failure.I_pos_f0 +
				        	  " - state: " + O_dom_navi_01.O_xpath2dom_parsing_failure.E_parsing_state.name() +
				        	  " - char expected: " +  O_dom_navi_01.O_xpath2dom_parsing_failure.C_actually_found) : ""));
		return;
	}
